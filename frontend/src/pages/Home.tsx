...
const Home = () => {
    ...
    const features: ReadonlyArray<Feature> = [
        //ReadonlyArray para que não seja possível modificar o array
        {
    ...
    return (
        <div className="bg-gray-950 min-h-screen">
            <div className="container-app">
                ...
                <section className="py-12 md:py-20 bg-gray-900 rounded-xl">
                    <div className="container-app">
                        <div className="text-center mb-12">
                            <h2 className="text-3xl font-bold text-white">Recursos do DevBills</h2>
                ...
                <section className='py-12 md:py-20'>
                    <div className='bg-gray-900 p-8 md:p-12 rounded-xl text-center border-gray-700'>
                        ...
                        <Button onClick={() => navigate('/login')} type='button' className='mx-auto px-6 py-3'>Criar Conta Gratuita</Button>
                    </div>
                </section>
            </div>
        </div>
