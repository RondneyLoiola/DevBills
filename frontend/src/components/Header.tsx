...
const Header = () => {
    ...
    const renderAvatar = () => {
        ...
        return <img 
            ...
            alt={`Avatar de ${authState.user.displayName || 'usuário'}`} 
            className="w-8 h-8 rounded-full border border-gray-700"
        />
    }
    
    const inicial = authState.user.displayName?.charAt(0)?.toUpperCase() || '?'
        ...
        <header className="bg-gray-900 border-b border-gray-700">
            <div className="container-app">
                <div className="flex justify-between items-center py-4">
                    {/* Logo */}
                    <Link to={"/"} className="flex gap-2 text-xl text-primary-600 items-center font-bold">
                    ...
                    <div className="md:hidden flex items-center">
                        <button 
                        type="button" 
                        className="text-gray-400 p-2 rounded-full hover:bg-gray-800 transition-colors cursor-pointer"
                        onClick={changeMenu}> 
                ...
                <div>
                    <div>
                        ...
                        <>
                            ...
                            <div className="flex items-center justify-between p-4 border-t border-gray-700 md:hidden">
                                <div className="flex items-center space-x-2">
                                    {renderAvatar()}
                            ...
                            <Link 
                            to={"/login"}
                            className="bg-primary-500 text-gray-800 font-semibold px-5 py-2.5 rounded-xl flex items-center justify-center hover:bg-primary-600 transition-all"
                            onClick={() => setIsOpen(false)}
                            >
                                Entrar
                            </Link>
